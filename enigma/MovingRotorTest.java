...
public class MovingRotorTest {
    ...
    @Test
    public void checkRotorRingSettingBAdvance() {
        setRotor("II", NAVALA, "");
        rotor.setRingSetting("B");
        rotor.advance();
        checkRotor("Rotor II advanced", UPPER_STRING, NAVALA_MAP.get("II"));
    }

    @Test
    public void checkRotorRingSettingZSet() {
        setRotor("III", NAVALA, "");
        rotor.setRingSetting("Z");
        rotor.set(25);
        checkRotor("Rotor III set", UPPER_STRING, NAVALA_MAP.get("III"));
    }
